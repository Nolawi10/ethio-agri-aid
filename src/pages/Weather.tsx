...
const Weather = () => {
  ...
  const weatherData: { [key: string]: any } = {
    "addis-ababa": {
      ...
      forecast: [
        ...
        { day: "ማክሰኞ", dayEn: "Tue", high: 23, low: 15, icon: Cloud, condition: "ደመናማ", rainChance: 30 },
    ...
    "mekelle": {
      ...
      forecast: [
        ...
        { day: "ሐሙስ", dayEn: "Thu", high: 24, low: 12, icon: Cloud, condition: "ደመናማ", rainChance: 25 },
    ...
    "gondar": {
      ...
      forecast: [
        ...
        { day: "ሐሙስ", dayEn: "Thu", high: 22, low: 11, icon: CloudRain, condition: "ከባድ ዝናብ", rainChance: 55 },
  ...
  const hourlyForecast = [
    ...
    { time: "12:00", temp: 22, icon: CloudSun, condition: "ከፊል ደመናማ", rain: 10 },
    { time: "15:00", temp: 23, icon: Cloud, condition: "ደመናማ", rain: 25 },
    { time: "18:00", temp: 20, icon: Sunset, condition: "ምሽት", rain: 15 },
    { time: "21:00", temp: 16, icon: Cloud, condition: "ደመናማ", rain: 5 },
    { time: "00:00", temp: 13, icon: Cloud, condition: "ደመናማ", rain: 0 },
    { time: "03:00", temp: 12, icon: Cloud, condition: "ደመናማ", rain: 0 },
  ];
  ...
  const seasonalCalendar = [
    ...
    { monthAm: "ኅዳር", activity: "የአትክልት መዝራት", crops: "ጎመን, ካሮት", status: "upcoming" },
    { monthAm: "ታኅሣሥ", activity: "ማጨድ", crops: "ጤፍ, በቆሎ", status: "upcoming" },
