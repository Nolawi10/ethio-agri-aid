    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold flex items-center justify-center gap-2">
          ...
          <span className="ethiopic">ቡና እና EthioAgri</span> / Coffee & EthioAgri
        </h2>
        <p className="text-muted-foreground text-sm">Ethiopia — The Birthplace of Coffee</p>
      </div>
      ...
      <Card className="p-6 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { value: "500K+", label: "Tons Annually", icon: BarChart3 },
            { value: "50%+", label: "Productivity Boost", icon: TrendingUp },
            { value: "50-60%", label: "Crop Loss Risk", icon: AlertTriangle },
            { value: "30%", label: "Less Chemicals", icon: Shield },
          ].map((stat) => (
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-bold text-center">
          <span className="ethiopic">ከፍተኛ 3 የቡና ገዳዮች</span> / Top 3 Coffee Crop Killers
        </h3>
          ...
          <Card className="p-5 border-destructive/20 bg-destructive/5">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h4 className="font-bold text-sm">Coffee Leaf Rust (CLR)</h4>
                  <p className="text-xs ethiopic text-muted-foreground">የቡና ቅጠል ዝገት</p>
                </div>
              </div>
          ...
          <Card className="p-5 border-destructive/20 bg-destructive/5">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <span className="text-2xl">🫐</span>
                <div>
                  <h4 className="font-bold text-sm">Coffee Berry Disease (CBD)</h4>
                  <p className="text-xs ethiopic text-muted-foreground">የቡና ፍሬ በሽታ</p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
          ...
          <Card className="p-5 border-destructive/20 bg-destructive/5">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <span className="text-2xl">🪵</span>
                <div>
                  <h4 className="font-bold text-sm">Coffee Wilt Disease</h4>
                  <p className="text-xs ethiopic text-muted-foreground">የቡና መድረቅ በሽታ</p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
      ...
      <Card className="p-6 bg-gradient-to-br from-primary/5 via-success/5 to-accent/5">
        <h3 className="text-lg font-bold mb-4 text-center">
          <span className="ethiopic">ለምን አስፈላጊ ነው?</span> / Why It Matters
        </h3>
        <div className="grid md:grid-cols-3 gap-4">
      ...
      <Card className="p-6 text-center space-y-3">
        ...
        <h3 className="text-lg font-bold">
          <span className="ethiopic">እንዴት ይሰራል?</span> / How It Works
        </h3>
